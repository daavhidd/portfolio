      ...
      <div className='overflow-hidden'>
        <div id="home" className="relative h-screen overflow-hidden px-6 md:px-16">
          <div className="relative z-10 flex flex-col justify-center h-full text-left ">
            ...
            <div >
              <a href='/Resume/David Nwokeabia.pdf' download="resume.pdf" className='inline-block reserv-space rounded-md bg-[#45154e] text-white px-8 py-3 md:px-12 md:py-2 hover:bg-[#ab92af] herobtn poppins-500 text-xs md:text-base'>
        ...
        <div id="about" className='bg-[#1C1C1C] grid-con py-24 px-6 md:py-24 md:px-16 overflow-hidden'>
          <div className='py-4 poppins-400 my-auto'>
            ...
            <div className='pt-4'>
              ...
              <p className='text-white text-justify text-sm mb-2'>
                My expertise lies in using technologies like ReactJs, NextJs, JavaScript, Typescript and Tailwind css to build engaging user interfaces that are not only visually appealing but also functional.
              </p>
              <p className='text-white text-justify text-sm mb-2'>
        ...
        <div id="work" className='bg-[#1C1C1C] pt-20 pb-24 px-6 md:pt-24 md:px-16 poppins-400'>
          ...
          <div className="w-full my-12">
            <a 
              href="https://www.linkedin.com/in/david-nwokeabia/" 
              target="_blank" 
